...
#-----------------------------------------------------------------
#언팩킹 (unpacking)방식 :  변1,변2, ......변n = tuple 방식
#                         변수명 개수 == 데이터 수  동일해야됨
#----------------------------------------------------------------
...
#------------------------------------------------------------
# 생성자 (constructor) 함수 : 타입명과 동일한 이름 함수
...
ds=dict(name=1, age=2, gender='남')  #오른쪽 문자열은 '', "" 써야됨
print(ds)
